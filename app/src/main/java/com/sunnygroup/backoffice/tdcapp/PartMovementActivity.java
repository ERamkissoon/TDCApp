...
import com.sunnygroup.backoffice.tdcapp.adapters.PartMovementAdapter;
import com.sunnygroup.backoffice.tdcapp.requests.DataVolleyRequest;

import org.json.JSONObject;

public class PartMovementActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_part_movement);
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(mContext, PartMovementFormActivity.class);
    ...
    protected void loadHistory () {
        recyclerView = (RecyclerView) findViewById(R.id.part_movement_recycler_view);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        adapter = new PartMovementAdapter(response);
